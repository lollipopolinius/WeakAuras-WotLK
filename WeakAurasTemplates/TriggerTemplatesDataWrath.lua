...
local templates =
  {
    ...
    general = {
      title = L["General"],
      icon = select(3,GetSpellInfo(49238)),
      args = {}
    },
  }
...
templates.class.WARRIOR = {
  [1] = {
    [1] = {
      ...
      icon = select(3,GetSpellInfo(2565))
    },
    [2] = {
      title = L["Debuffs"],
      args = {
    ...
    [3] = {
      ...
      icon = select(3,GetSpellInfo(64382))
    },
    [4] = {},
    [5] = {},
    [6] = {},
...
templates.class.PALADIN = {
  [1] = {
    [1] = {
      ...
      icon = select(3,GetSpellInfo(6940))
    },
    [2] = {
      title = L["Debuffs"],
      args = {
      ...
      icon = select(3,GetSpellInfo(853))
    },
    [3] = {
      title = L["Abilities"],
      args = {
      ...
      icon = select(3,GetSpellInfo(53595))
    },
    [4] = {},
    [5] = {},
    [6] = {},
...
templates.class.HUNTER = {
  [1] = {
    [1] = {
      ...
      icon = select(3,GetSpellInfo(24450))
    },
    [2] = {
      title = L["Debuffs"],
      args = {
      ...
      icon = select(3,GetSpellInfo(24394))
    },
    [3] = {
      title = L["Abilities"],
      args = {
      ...
      icon = select(3,GetSpellInfo(53351))
    },
    [4] = {},
    [5] = {},
    [6] = {},
  ...
  [1] = {
    [1] = {
      ...
      args = {
        ...
        { spell = 58427, type = "buff", unit = "player"}, -- Overkill
      },
      icon = select(3,GetSpellInfo(14278))
    },
    [2] = {
      title = L["Debuffs"],
      args = {
      ...
      icon = select(3,GetSpellInfo(14183))
    },
    [3] = {
      title = L["Abilities"],
      args = {
        ...
        { spell = 14278, type = "ability", requiresTarget = true, buff = true, talent = 87}, -- Ghostly Strike
      ...
      icon = select(3,GetSpellInfo(57934))
    },
    [4] = {},
    [5] = {},
    [6] = {},
...
templates.class.PRIEST = {
  [1] = {
    [1] = {
      ...
      icon = select(3,GetSpellInfo(1706))
    },
    [2] = {
      title = L["Debuffs"],
      args = {
      ...
      icon = select(3,GetSpellInfo(34914))
    },
    [3] = {
      title = L["Abilities"],
      args = {
...
templates.class.SHAMAN = {
  [1] = {
    [1] = {
      ...
      icon = select(3,GetSpellInfo(16256))
    },
    [2] = {
      title = L["Debuffs"],
      args = {
      ...
      icon = select(3,GetSpellInfo(3600))
    },
    [3] = {
      title = L["Abilities"],
      args = {
      ...
      icon = select(3,GetSpellInfo(61295))
...
templates.class.MAGE = {
  [1] = {
    ...
    [2] = {
      ...
      icon = select(3,GetSpellInfo(11180))
    },
    [3] = {
      title = L["Abilities"],
      args = {
      ...
      icon = select(3,GetSpellInfo(44572))
    },
    [4] = {},
    [5] = {},
    [6] = {},
...
templates.class.WARLOCK = {
  [1] = {
    ...
    [2] = {
      ...
      icon = select(3,GetSpellInfo(48181))
    },
    [3] = {
      title = L["Abilities"],
      args = {
        ...
        { spell = 17877, type = "ability", requiresTarget = true, debuff = true, talent = 88}, -- Shadowburn
      ...
      icon = select(3,GetSpellInfo(48020))
    },
    [4] = {},
    [5] = {},
    [6] = {},
...
templates.class.DRUID = {
  [1] = {
    [1] = {
      ...
      icon = select(3,GetSpellInfo(33763))
    },
    [2] = {
      title = L["Debuffs"],
      args = {
    ...
    [3] = {
      ...
      icon = select(3,GetSpellInfo(50334))
    },
    [4] = {},
    [5] = {},
    [6] = {},
...
templates.class.DEATHKNIGHT = {
  [1] = {
    [1] = {
      ...
      icon = select(3,GetSpellInfo(66799))
    },
    [2] = {
      title = L["Debuffs"],
      args = {
      ...
      icon = select(3,GetSpellInfo(59879))
    },
    [3] = {
      title = L["Abilities"],
      args = {
      ...
      icon = select(3,GetSpellInfo(66198))
    },
    [4] = {},
    [5] = {},
    [6] = {},
...
tinsert(templates.general.args, {
  title = L["Cast"],
  icon = select(3,GetSpellInfo(131)),
  type = "cast"
});
tinsert(templates.general.args, {
